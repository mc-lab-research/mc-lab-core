...
static_assert(
    !sem::TransitionRelation<models::generated_branching_system, int>);
...
static_assert(std::same_as<sem::post_range_for_t<models::iterated_map, int>,
                           std::array<int, 1>>);
static_assert(
    std::same_as<sem::post_reference_for_t<models::iterated_map, int>, int&>);
