...
// implementations.
//
// This is the A01 by-value attempt. It was classified INCONCLUSIVE as the
// controlled ARC result because it did not instantiate the frozen ephemeral-
// proxy lifetime. Its passing run is retained as Exploratory evidence for the
// narrower owning-value representation and for comparison with A02.
#include "../common/support/labelled_successor_consumer.hpp"
