...
did not meet the frozen proxy-invalidation requirement. The rerun configuration
is to be frozen independently from the ARC-001 case freeze rather than added to
this attempt's history.
