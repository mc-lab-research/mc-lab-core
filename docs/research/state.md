...
**Next principal action:** Separate the maintained ARC-001 research apparatus
from ordinary engineering tests. The accepted result is recorded by annotated
tag `arc-001-a02-supports-ha`.
