...
template <class System, class Transition>
concept TransitionLabelValue =
    TransitionLabelCallable<System, Transition>
...
using transition_label_for_t =
    detail::transition_label_for_t<System, Transition>;
