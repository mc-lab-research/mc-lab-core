...
concept FiniteAutomatonTransitionStructure =
    ...
    && TransitionLabelling<System,
                           transition_reference_for_t<System, state_t<System>>>;

template <class System>
concept FiniteAutomatonAcceptance =
    HasAcceptanceCondition<System>
    && FinalStateAcceptanceCondition<acceptance_condition_t<System>,
                                     state_t<System>>;

template <class System>
concept FiniteAutomatonComponents = FiniteAutomatonTransitionStructure<System>
                                    && FiniteAutomatonAcceptance<System>;
